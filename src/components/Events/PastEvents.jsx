    ...
    <div className="events-page page-transition">
      ...
      <div className="events-hero">
        ...
        <p className="fade-in-up">
          Take a look at our previous events and see what we've accomplished
          together.
        </p>
        <Link to="/events" className="cta-button fade-in-up">
          Back to Events
        </Link>
      </div>
      ...
      <div className="events-cta fade-in-up">
        ...
        <p>
          Interested in collaborating on an event? We're always looking for
          partners!
        </p>
